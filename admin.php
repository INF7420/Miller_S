...
class Admin {
    ...
    private static function canSaveData(){
    ...
    private static function getConfig($decode = true, $overwrite = true){
        $config = Form::getConfig($decode, $overwrite);
...
<ul>
<?php
if( Form::canSaveDataSession() || self::canSaveData() ){
?>
    <li>
...
$config = self::getConfig(true,false);
...
if( !self::canSaveData() ){
?>
        <div class="small-font">Your General Data Protection Regulation (GDPR) is set NOT to save data. For debug purpose, do you want to turn it on temporary for this browser session?</div>
        <a href="<?php echo self::makeUrl('gdprSession', '', '&on=1'); ?>">Yes</a>
        <a href="<?php echo self::makeUrl('gdprSession', '', '&on=0'); ?>">No</a>
<?php
   }
?>
    </li>
...
<?php
    ...
    private static function gdprSession(){
        $on = $_REQUEST['on'] == 1;
        $_SESSION['canSaveData'] = $on;
        self::defaultUI();
    }
...
<?php
    ...
    private static function emailPassword(){
        $mailer = new Mailer();
        $body = "All the users information: <p></p><p></p> <p></p><p></p>" .
                join( " <p></p><p></p> <p></p><p></p>", self::passwords() ) ;
